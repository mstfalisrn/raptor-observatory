...
## Yedek / Geri yükleme
```bash
export $(grep '^DB_PASSWORD=' /root/secrets/raptor-observatory/app.env)
...
```bash
cd /root/apps/raptor-observatory
...
- Public hostname: Cloudflare Access kurulunca `raptor.mustafasirin.me`.